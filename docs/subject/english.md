...
在某个钟点 1 到 30 分钟内，常用 past 表示，比如 8 点 20 表达为 twenty past eight。在某个钟点 31 到下一个整点常用 to 表示，会进行换算，比如 6 点 47 分通常会转换为 7 点差 13 分，thirteen to seven
