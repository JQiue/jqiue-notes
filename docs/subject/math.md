...
指数表示与自身相乘多少次，比如 7^5^ 表示 5 个 7 相乘，其中 7 是底数，5 是指数，使用指数的原因是将很长的重复数相乘简写。平方是指数为 2 的数，立方是指数为 3 的数。求 n 个相同因数的积的运算叫做**乘方**，而它们的结果叫做**幂**
...
::: tip
指数为零的乘方都等于 1，0 的任何次幂都是 0
:::

求一个数的平方根的运算，叫做开平方，这个数叫做**被开方数**。一个数的平方根是一个可以与自己相乘得到原数的数字，平方运算（幂运算）和开平方运算互为逆运算。如果一个数的平方根是一个整数，这个数被称为**完全平方**
