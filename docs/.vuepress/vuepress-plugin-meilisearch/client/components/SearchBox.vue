<template>
  <div class="meilisearch">
    <form id="search-form" class="algolia-search-wrapper search-box" role="search" @submit="handleSubmit">
      <span class="algolia-autocomplete algolia-autocomplete-right"
        style="position: relative; display: inline-block; direction: ltr;">
        <input @blur="() => hideModal()" @keyup.down="handleCurrentIndex('+')" @keyup.up="handleCurrentIndex('-')"
          @input="handleInput" v-model="query" id="search-bar-input" class="search-query ds-input" placeholder="Search..."
          autocomplete="off" spellcheck="false" role="combobox" dir="auto"
...
import { modalVisible, query, currentIndex, isLoading, hits, hideModal, showModal } from '../global';
...
.search-box input {
  ...
  background: #fff url(../asserts/search.svg) .6rem .5rem no-repeat;
...
div[data-ds-theme=dark] .searchbox input::-webkit-search-decoration,
div[data-ds-theme=dark] .searchbox input::-webkit-search-cancel-button,
div[data-ds-theme=dark] .searchbox input::-webkit-search-results-button,
div[data-ds-theme=dark] .searchbox input::-webkit-search-results-decoration {
  display: none;
}
...
div[data-ds-theme=dark] .searchbox input:focus,
div[data-ds-theme=dark] .searchbox input:active {
  outline: 0;
...
div[data-ds-theme=dark] .searchbox__submit:hover,
div[data-ds-theme=dark] .searchbox__submit:active {
  cursor: pointer;
}
...
div[data-ds-theme=dark] .meilisearch-autocomplete .docs-searchbar-suggestion--category-header .docs-searchbar-suggestion--category-header-lvl0 .docs-searchbar-suggestion--highlight,
div[data-ds-theme=dark] .meilisearch-autocomplete .docs-searchbar-suggestion--category-header .docs-searchbar-suggestion--category-header-lvl1 .docs-searchbar-suggestion--highlight {
  padding: 0 0 1px;
  background: inherit;
  box-shadow: inset 0 -2px 0 0 rgba(69, 142, 225, 0.8);
  color: inherit;
...
div[data-ds-theme=dark] .meilisearch-autocomplete .suggestion-layout-simple .docs-searchbar-suggestion--category-header-lvl0,
div[data-ds-theme=dark] .meilisearch-autocomplete .suggestion-layout-simple .docs-searchbar-suggestion--category-header-lvl1 {
  opacity: 0.6;
  font-size: 0.85em;
  opacity: unset;
  color: #d5d5d5;
...
div[data-ds-theme=dark] .meilisearch-autocomplete .suggestion-layout-simple .docs-searchbar-suggestion--duplicate-content,
div[data-ds-theme=dark] .meilisearch-autocomplete .suggestion-layout-simple .docs-searchbar-suggestion--subcategory-inline {
  display: none;
}
