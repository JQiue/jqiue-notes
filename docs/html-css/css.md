...
<p style="text-align:justify">两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对齐 两端 对齐  两端对齐 两端对齐两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对齐 两端 对齐  两端对齐 两端对齐</p>
<p style="text-align:justify-all">两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对齐 两端 对齐  两端对齐 两端对齐两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对 齐 两 端 对齐 两端 对齐  两端对齐 两端对齐</p>
```
