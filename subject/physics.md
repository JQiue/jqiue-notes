...
在这用电量激增，电费飙涨的时代，电和阳光，空气，水一样早已成为人类无法摆脱的依赖。要理解电，必须从电的最小基本粒子，也就是电子说起，电子存在所有的元素中，当电子离开原子本身而自由流动就形成流动的电，这就是电流。其中元素周期表中的，铜镞元素铜银金由于外层电子只有一个落单的电子，很容易受外力影响而离开原子，适合作为良好的电流导体，但铜最容易获得，所以作为大部分导线材料

要让电子离开原子自由流动，需要施加一定的压力，就像水会从高水压流想低水压形成水流。电也会从高电压流向低电压而形成电流，电压常用单位是**伏特（V）**，当负电电子流往某个方向就等效于正电电子流往相反的方向，一般将正电电荷的方向作为电流方向。量化电流大小的单位是安培（A）。在固定的电流和电压下就能以公式：P = IV 得到功率，单位是瓦特。所以即使是十万伏特，但电流只有十万分之一的安培，实际功率连一盏灯都无法点亮，一般电器都会标注电压，电流与功率指标

电路是由导体组成的封闭回路，提供电流往返的路径，由于电荷不会平白无故的增加或减少，当回路有分岔时，进入分岔点的电流总和一定会等于离开分叉点的电流总和。同时为了维持回路稳定，电压在经过回路升降之后回到原点必定会维持相同电压，也就是回路的电压升降总和势必为 0，这就是**克希荷夫定律**

在没有驱动力的电路上，电子会安稳的停在各自的原子旁边，不会形成电流，一旦加入有电压的电源，电子就会被推动而开始在这个回路上流动形成电流。其中，电流会有直流（DC）和交流（AC）之分，各类电池都是直流电，各种电源插座就是交流电

如果一个电流回路没有任何阻力，持续的高电压向低电压，以超高功率把能量释放为热能进而烧坏电路，这种情况称为短路。让电流变小的直接方式就是添加**电阻**（R）,电压，电流，电阻之间的关系符合欧姆定律：V = IR，电阻的单位是欧姆，因此在 1V 的电压下，能控制电流在 1A 的电阻值为 1R。任何电子器件都有各自的电阻，甚至导线本身都有电阻，也可以直接添加恒定电阻值的电阻器

电容是一个种能够在电压带动下存储正负电荷进而缓和电压变化的电子器件，在电容两端施加电压时，电容两边会逐渐累计正负电荷，直到两端电压与外部施加的电压相互抵消为止，一旦外部电压消失或降低，电容本身的电压就能将存储的正负电荷逐步释放出来，对于电流而言，电容就像一个水库。电容有缓和电压的作用，在外部电压不稳定的情况下能让后续器件保持相对稳定的电压。对于交流电，来回摆动的电流会轮流在电容两边充放电等同通路一样，电容大小由公式：C = Q/V，常用单位是法拉（F）,在 1v 电压下，能存储 1C 电量的电容量为 1F

电感是回路中的属性，主要由线圈组成，一旦电流通过回路就会产生电磁感应，利用电磁感应储存和释放磁能产生临时的电压以抵抗电流的改变，因此有平滑电流变化的效果作用，对于直流电就像在水管中装了涡轮，当水流通过时，会需要一点力气让涡轮转动，一旦涡轮转动，即使外部压力消失也会惯性的转动下去继续带动水流直到涡轮的能量全部转移出去，而对于交流电，则会对来回摆动的电流形成阻抗

电阻，电容，电感只是作为电器中配合辅助的角色只是被动器件，要达到精准控制电流的目的，要慎选导电材料，容易导电的物体是**导体**，不容易导电的是**绝缘体**。导体导电原因是导体容易失去电子，绝缘体不容易失去电子。导体和绝缘体没有绝对的界限，在一定条件改变时可以相互转化。**半导体**的导电能力介于导体和绝缘体之间，非常适合作为控制电流的通过与否
...
+ 瓦特：
+ 焦耳：
+ 伏特：移动每库伦的电荷所需要消耗的焦耳能量
+ 安培：1 安培指每秒钟通过 1 库伦的电荷数量
+ 库伦：1A 电流在 1秒种通过的电量，1A = 1C/s
+ 直流电：电压和电流方向固定
+ 交流电：电压与电流方向随时间周期变化
+ 电阻：
